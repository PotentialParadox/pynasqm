...
file for guidance on the inputs. Any further question can be referred to [[dtracy@ufl.edu][Dustin
Tracy]]. The high performance computer section is designed to work with Slurm
