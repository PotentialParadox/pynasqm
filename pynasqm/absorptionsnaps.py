...
class AbsorptionSnaps(Trajectories):
    ...
    def __init__(self, user_input, input_ceon):
        ...
        self._number_trajectories = user_input.n_snapshots_abs
    ...
    def _move_restarts(self):
        for i, filename in enumerate(self._initial_snaps(), start=1):
            new_restart_name = "snap_for_abs_t{}_r{}.rst".format(i, self._user_input.restart_attempt)
            directory = "abs/traj_{}/restart_{}/{}".format(i, self._user_input.restart_attempt, new_restart_name)
